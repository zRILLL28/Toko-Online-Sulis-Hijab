$(function() {
    ...
    Morris.Area( {
        ...
        ], lineColors:["#009688", "#fdb93e", "#148cca"], xkey:"y", ykeys:["a", "b", "c"], labels:["a", "b", "c"], pointSize:0, lineWidth:0, resize:!0, fillOpacity:.8, behaveLikeLine:!0, gridLineColor:"#e0e0e0", hideHover:"auto"
    }
    ), Morris.Bar( {
        element:"morris-bar-chart", data:[ {
            y: "Project-1", a: 1e4, b: 8e3, c: 7800
        }
        , {
            y: "Project-2", a: 8500, b: 7e3, c: 6500
        }
        , {
            y: "Project-3", a: 9e3, b: 7500, c: 7e3
        }
        , {
            y: "Project-4", a: 9500, b: 8500, c: 7500
        }
        , {
            y: "Project-5", a: 7500, b: 5500, c: 5e3
        }
        ], barGap:8, barSizeRatio:.3, barShape:"soft", barRadius:[5, 5, 5, 5], xkey:"y", ykeys:["a", "b", "c"], labels:["Total", "Used", "Target"], barColors:["#44a2d2", "#98d4ce", "#c1d1de"], hideHover:"auto", preUnits:"$", gridLineColor:"#eef0f2", resize:!0
    }
    ), $(".knob").knob( {
        format:function(e) {
            return e+"%"
        ...
        ], resize:!0, colors:["#e3eaef", "#ff679b", "#777edd"], labelColor:"#888", backgroundColor:"transparent", fillOpacity:.1, formatter:function(e) {
            return e+"h"
        }
    }
    ), $(function() {
