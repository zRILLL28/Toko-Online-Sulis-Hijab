        ...
        <div class="page-title-box">
            <div class="float-right">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tabel Customer</li>
                </ol>
            </div>
            <h4 class="page-title">Tabel Customer</h4>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <h5 class="pb-3 mt-0">Tabel Customer</h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-between">
                                    <a href="#"><i
                                            class="mdi mdi-lead-pencil border p-1 rounded tippy-btn" title="Edit customer"
                                            data-tippy-placement="top"></i></a>
                                    <a href="#" id="conf-delete"><i class="dripicons-trash border p-1 rounded tippy-btn"
                                            title="Hapus customer" data-tippy-placement="top"></i></a>
                                </td>
                            </tr>
                            @empty
